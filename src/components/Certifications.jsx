...
function Certifications({ onGoBack }) {
  return (
    <section className="w-full h-full flex flex-col items-start lg:items-center justify-start md:justify-center">
      <h1 className="font-bold text-[45px] sm:text-md lg:text-lg text-black dark:text-white mb-8 ">
        Certifications
        <span className="text-secondary">.</span>
      </h1>
      <div className="block lg:flex gap-7 justify-center sm:pr-16 mr-16 mb-16">
        <div className="hover:scale-105 transition-all shadow-lg w-full hover:bg-slate-10 dark:bg-darken hover:dark:bg-darker p-4 py-10 rounded-lg gap-4 flex flex-col items-center md:w-full lg:w-1/2 xl:w-1/3">
          <img
            src={htmlcss_badge}
          ...
          <div className="flex flex-col items-center">
            <p className="dark:text-slate-50 text-slate-800 text-justify mb-2 w-3/4">
              This certification demonstrates proficiency in HTML and CSS,
              covering the fundamentals of web development, including
              structuring and styling web pages effectively.
            </p>
            <a
        ...
        <div className="p-4 py-10 hover:scale-105 shadow-lg hover:bg-slate-10 dark:bg-darken hover:dark:bg-darker transition-all rounded-lg gap-4 flex flex-col items-center w-full md:w-full lg:w-1/2  xl:w-1/3">
          <img
            src={htmlcss_badge}
            alt="HTML/CSS Certification"
            className="h-48 w-48 md:w-1/3 md:h-1/3 lg:w-52 lg:h-52 object-cover mb-4 rounded-full"
