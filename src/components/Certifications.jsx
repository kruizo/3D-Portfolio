  ...
  return (
    <section className="w-full h-full flex flex-col items-center justify-center">
      ...
      <div className="block lg:flex gap-7 justify-center sm:pr-16 lg:px-16 mx-16 mb-16">
        <div className="hover:scale-105 transition-all shadow-lg hover:bg-slate-10 dark:bg-darken hover:dark:bg-darker p-4 py-10 rounded-lg gap-4 flex flex-col items-center w-full lg:w-1/4">
          <img
            src={htmlcss_badge}
        ...
        <div className="p-4 py-10 hover:scale-105 shadow-lg hover:bg-slate-10 dark:bg-darken hover:dark:bg-darker transition-all rounded-lg gap-4 flex flex-col items-center w-full lg:w-1/4">
          <img
            src={htmlcss_badge}
            alt="HTML/CSS Certification"
            className="h-48 w-48 md:w-1/3 md:h-1/3 lg:w-52 lg:h-52 object-cover mb-4 rounded-full"
